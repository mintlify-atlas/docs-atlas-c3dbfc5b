  ...
  deploy:
    ...
    steps:
      ...
      - name: Prepare web root
        ...
        with:
          ...
          script: |
            ...
            rm -f ~/domains/unklefunk.music/public_html/default.php \
                  ~/domains/unklefunk.music/public_html/index.php
      ...
      - name: Check live site
        run: |
          sleep 5
          HTTP=$(curl -s -L -o /dev/null -w "%{http_code}" --max-time 15 https://unklefunk.music/)
