...
description: "Install OpenSwarm via npm and send your first multi-agent prompt in under a minute. Requires Node.js 20+ — Python 3.10+ is auto-installed."
---
...
<Steps>
  <Step title="Install OpenSwarm">
    ...
    **Requirements:** Node.js 20+ must be installed on your machine. Python 3.10+ is detected and installed automatically — you do not need to set up a Python environment yourself.
